...
public class TableAsistentesBrigadistas extends AbstractTableModel {

    private List<AsistenteCurso> TBR = new ArrayList<>();
    private final String[] columnas = {"Folio", "Nombre", "Brigada", "Área"};

    public TableAsistentesBrigadistas(List<AsistenteCurso> tbr) {
        this.TBR = tbr;
    }
