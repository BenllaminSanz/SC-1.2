...
public class TableHistorialCursoNombres extends AbstractTableModel {

    private List<HistorialCurso> curso = new ArrayList<>();
    private final String[] columnas
            = {"ID", "Nomina", "Fecha Inicio", "Fecha Estimada", "Fecha Cierre", "Estado"};

    public TableHistorialCursoNombres(List<HistorialCurso> tbr) {
        this.curso = tbr;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 1:
                return curso.get(rowIndex).getNombres();
            case 2:
