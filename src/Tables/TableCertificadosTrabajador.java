...
public class TableCertificadosTrabajador extends AbstractTableModel {

    private List<PersonalCertificado> TBR = new ArrayList<>();
    private final String[] columnas = {"ID","Certificado", "Tipo", "Status", "Fecha para Certificado"};

    public TableCertificadosTrabajador(List<PersonalCertificado> tbr) {
        this.TBR = tbr;
    }
